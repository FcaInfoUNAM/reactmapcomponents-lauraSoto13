...
function App() {
 const products = [
  ...
  {
     name: "Peluche de cabra abrazable",
     model: "978-1-74218-429-6",
     b64Image: "https://m.media-amazon.com/images/I/51EMd9BHnsL._AC_UF894,1000_QL80_.jpg",
     properties: "La cabra más abrazable en el mundo",
}];
  return (
    <>
    <div className="bg-orange-500 p-20 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-10">
